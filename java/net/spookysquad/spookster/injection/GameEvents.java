...
public class GameEvents {
	...
	public static void onPushOutOfBlocksEvent(final ReturnEventInfo<EntityPlayerSP, Boolean> e, final double arg1,
	...
	public static void onGetPlayerRelativeBlockHardnessEvent(final ReturnEventInfo<Block, Float> e,
			final EntityPlayer thePlayer, final World theWorld, final int x, final int y, final int z) {
		...
		e.setReturnValue((((hardness < 0.0f) ? 0.0f : (thePlayer.canHarvestBlock(block) ? (thePlayer.getBreakSpeed(block,
				true) / hardness / 30.0f) : (thePlayer.getBreakSpeed(block, false) / hardness / 100.0f)))));
	}

	public static void onPassSpecialRenderEvent(final EventInfo<RendererLivingEntity> e, final EntityLivingBase arg1,
			final double arg2, final double arg3, final double arg4) {
	...
	public static void onRenderLivingLabelEvent(final EventInfo<Render> e, final Entity arg1, final String arg2,
			final double arg3, final double arg4, final double arg5, final int arg6) {
	}
