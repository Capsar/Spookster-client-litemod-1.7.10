...
{	
	...
	protected void addEvents() {
       final Event preMotionUpdateEvent = Event.getOrCreate("preMotionUpdateEvent", true);
        ...
        preMotionUpdateEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "preMotionUpdateEvent"));
        ...
        postMotionUpdateEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "postMotionUpdateEvent"));
        ...
        onRenderBlockByRenderTypeEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onRenderBlockByRenderTypeEvent"));
        ...
        onPushOutOfBlocksEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onPushOutOfBlocksEvent"));
        ...
        isEntityInsideOpaqueBlockEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "isEntityInsideOpaqueBlockEvent"));
        ...
        onGetPlayerRelativeBlockHardnessEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onGetPlayerRelativeBlockHardnessEvent"));
        ...
        onPassSpecialRenderEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onPassSpecialRenderEvent"));
        ...
        onRenderLivingLabelEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onRenderLivingLabelEvent"));   
        ...
        onAddToSendQueueEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onAddToSendQueueEvent"));
        ...
        onAddCollisionEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onAddCollisionEvent"));
        ...
        onAttackEntityEvent.addListener(new MethodInfo("net.spookysquad.spookster.injection.GameEvents", "onAttackEntityEvent"));
    }
}
